...
func init() {
	...
	configureCmd.Flags().StringVarP(&configureCmdArgs.localhostIP, "localhost-ip", "l", configureCmdArgs.localhostIP, "Redirect wiretap packets destined for this IPv4 address to server's localhost")
